...
int main(){
    ...
    returnVal = cardEffectMinion(1, 0, &G, handPos);
    ...
    // returnVal;
    // call the refactoredfunction
    returnVal = cardEffectMinion(0, 1, &G, handPos);
    ...
    // returnVal;
    // call the refactoredfunction
    returnVal = cardEffectMinion(0, 0, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectMinion(1, 1, &G, handPos);
