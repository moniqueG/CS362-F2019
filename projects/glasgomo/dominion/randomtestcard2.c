...
int checkMinion(int choice1, int choice2, struct gameState *post, int handPos) {
    ...
    r = cardEffectMinion(choice1, choice2, post, handPos);
    ...
    if(r == -1){
        printf("cardEffectMinion ORIGINAL: p - %d, HC - %d, NA - %d, C - %d, DiC - %d, PCC - %d\n",
        ...
        printf("cardEffectMinion EXPECTED: p - %d, HC - %d, NA - %d, C - %d, DiC - %d, PCC - %d\n",
            pre.whoseTurn, pre.handCount[pre.whoseTurn], pre.numActions,pre.coins, pre.discardCount[pre.whoseTurn], pre.playedCardCount);

        printf("cardEffectMinion ACTUAL: p - %d, HC - %d, NA - %d, C - %d, DiC - %d, PCC - %d\n\n",
