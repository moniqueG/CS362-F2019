...
int main(){
    ...
    returnVal = cardEffectAmbassador(1, 0, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(1, 1, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(2, 1, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(1, 3, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(1, 2, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(2, 0, &G, handPos);
    ...
    // call the refactoredfunction
    returnVal = cardEffectAmbassador(0, 2, &G, handPos);
