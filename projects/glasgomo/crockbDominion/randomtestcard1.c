...
int checkBaron(int choice1, struct gameState *post, int firstEstate, int handPos) {
    ...
    r = playBaron(choice1, post, handPos);
    ...
    if(r == -1){
        printf("playBaron ORIGINAL: p - %d, HC - %d, NB - %d, C - %d, DiC - %d, EsS - %d\n",
...
int main(){
    ...
    for(j = 0; j < 1000; j++){
        ...
        checkBaron(choice1, &G, firstEstate, handPos);
