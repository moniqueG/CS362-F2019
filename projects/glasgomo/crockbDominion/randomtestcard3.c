...
int checkTribute(struct gameState *post, int handPos) {
    ...
    if(r == -1){
        printf("playTribute ORIGINAL: p - %d, HC - %d, NA - %d, C - %d, DiC - %d, PCC - %d, TB1 - %d, TB2 - %d\n",
...
int main(){
    ...
    printf("Begin Random Tests playTribute\n");
    //
